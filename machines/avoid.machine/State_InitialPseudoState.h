...
//
#ifndef __clfsm__avoid_State_InitialPseudoState_h__
#define __clfsm__avoid_State_InitialPseudoState_h__
...
#endif // defined(__gufsm__avoid_State_InitialPseudoState__)
