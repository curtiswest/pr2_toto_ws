...
//
#ifndef __clfsm__stroll_State_InitialPseudoState_h__
#define __clfsm__stroll_State_InitialPseudoState_h__
...
#endif // defined(__gufsm__stroll_State_InitialPseudoState__)
